...
//@AutoClone
@EqualsAndHashCode
class G2fPrincipal implements CloneablePrincipal {
    @Nonnull
    @NotEmpty
     ...
     * @param username
     */
    G2fPrincipal(@Nonnull @NotEmpty @ParameterName(name="name") final String name) {
    ...
    /** {@inheritDoc} */
    @Override
    G2fPrincipal clone() throws CloneNotSupportedException {
        final G2fPrincipal copy = (G2fPrincipal) super.clone()
